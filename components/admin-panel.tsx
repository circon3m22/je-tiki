...
function contentBlockTitle(key: string) { return ({ hero: "Первый экран", home_intro: "Вступление о бренде", about: "О мастерской", contacts: "Контакты и подвал" } as Record<string, string>)[key] ?? key; }
